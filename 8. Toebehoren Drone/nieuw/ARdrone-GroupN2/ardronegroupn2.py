...
def main():
    ...
    file = open("logdata_ardronevoorachterpsinul.txt", "w")
    ...
    while running:
        ...
        try:
            ...
            hud7 = f.render('theta: %i%%' % theta, True, hud_color2)
            hud8 = f.render('phi: %i%%' % phi, True, hud_color3)
            ...
            #hud12 = f.render('dronestate: %.2f' % drone, True, hud_color)
